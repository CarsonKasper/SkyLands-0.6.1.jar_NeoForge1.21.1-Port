...
public class GlaciatedFliningIslandsFruitDecorator extends TreeDecorator {
   ...
   public static void registerTreeDecorator(RegisterEvent event) {
      event.register(net.minecraftforge.registries.ForgeRegistries.Keys.TREE_DECORATOR_TYPES, helper -> helper.register(ResourceLocation.fromNamespaceAndPath("flying_stuff", "glaciated_floating_islands_tree_fruit_decorator"), DECORATOR_TYPE));
   }

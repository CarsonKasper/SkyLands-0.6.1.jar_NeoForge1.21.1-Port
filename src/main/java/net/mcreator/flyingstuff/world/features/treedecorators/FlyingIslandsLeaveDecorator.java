...
public class FlyingIslandsLeaveDecorator extends TreeDecorator {
   ...
   public static void registerTreeDecorator(RegisterEvent event) {
      event.register(net.minecraftforge.registries.ForgeRegistries.Keys.TREE_DECORATOR_TYPES, helper -> helper.register(ResourceLocation.fromNamespaceAndPath("flying_stuff", "flying_islands_tree_leave_decorator"), DECORATOR_TYPE));
   }

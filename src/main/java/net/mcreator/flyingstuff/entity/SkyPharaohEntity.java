...
import net.mcreator.flyingstuff.procedures.SkyPharaohOnEntityTickUpdateProcedure;
...
public class SkyPharaohEntity extends Monster implements GeoEntity {
   private static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(SkyPharaohEntity.class, EntityDataSerializers.BOOLEAN);
   private static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(SkyPharaohEntity.class, EntityDataSerializers.STRING);
   private static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(SkyPharaohEntity.class, EntityDataSerializers.STRING);
   private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
   private String animationprocedure = "empty";
   private long lastSwing;


   public SkyPharaohEntity(EntityType<SkyPharaohEntity> type, Level world) {
      super(type, world);
      this.xpReward = 0;
      this.setNoAi(false);
   ...
   protected void defineSynchedData(SynchedEntityData.Builder builder) {
      ...
      builder.define(TEXTURE, "sky_pharaoh");
   }
   ...
   public void tick() {
      super.tick();
      SkyPharaohOnEntityTickUpdateProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
   ...
   private PlayState movementPredicate(AnimationState event) {
      if (this.animationprocedure.equals("empty")) {
         return !event.isMoving() && event.getLimbSwingAmount() > -0.15F && event.getLimbSwingAmount() < 0.15F
            ? event.setAndContinue(RawAnimation.begin().thenLoop("animation.model.idle"))
            : event.setAndContinue(RawAnimation.begin().thenLoop("animation.model.walking"));
      } else {

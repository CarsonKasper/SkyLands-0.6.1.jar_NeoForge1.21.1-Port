...
public class IceArrowProjectileHitsLivingEntityProcedure {
   public static void execute(Entity entity) {
      if (entity != null) {
         if (entity instanceof LivingEntity _entity && !_entity.level().isClientSide()) {
            _entity.addEffect(new MobEffectInstance(Holder.direct((MobEffect)FlyingStuffModMobEffects.FROZEN.get()), 40, 1));
         }

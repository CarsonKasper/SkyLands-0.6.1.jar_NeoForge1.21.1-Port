...
public class HeadsetArmorTrimSmithingTemplateItem extends Item {
   public HeadsetArmorTrimSmithingTemplateItem() {
   ...
   public void appendHoverText(ItemStack itemstack, net.minecraft.world.item.Item.TooltipContext level, List<Component> list, TooltipFlag flag) {
      ...
      list.add(Component.literal("Headset Armor Trim"));
   }
}

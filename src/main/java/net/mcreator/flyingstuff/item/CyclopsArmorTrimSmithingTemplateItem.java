...
public class CyclopsArmorTrimSmithingTemplateItem extends Item {
   public CyclopsArmorTrimSmithingTemplateItem() {
   ...
   public void appendHoverText(ItemStack itemstack, net.minecraft.world.item.Item.TooltipContext level, List<Component> list, TooltipFlag flag) {
      ...
      list.add(Component.literal("Cyclops Armor Trim"));
   }
}
